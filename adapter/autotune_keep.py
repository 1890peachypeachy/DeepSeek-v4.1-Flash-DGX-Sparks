...
_VOLATILE = ("DSV41_DRAFT_CAPTURE", "DSV41_DRAFT_CAPTURE_OUT", "DSV41_DRAFT_CAPTURE_TRIGGER",
             ...
             # the draft's own wo_a einsum route (TP3 bridge mode); the draft head kernel choice;
             # neither is a FlashInfer-tuned op
             "DSV41_WO_A_W8_DRAFT", "DSV41_DRAFT_HEAD_FP8_IMPL")
